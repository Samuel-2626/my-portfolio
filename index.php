...
<link href="https://fonts.googleapis.com/css2?family=Concert+One&display=swap" rel="stylesheet">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">DevSam</a>
...
<a href="https://samueltorimiro.info/Samuel Torimiro Resume.pdf" class="btn btn-lg">My Resume</a>
    ...
    <div data-target="#navbar-example2" data-spy="scroll" id="projects">
  ...
  <div class="card-body">
    ...
    <hr>
    <br>
    <div data-target="#navbar-example2" data-spy="scroll" id="connect">
    ...
    <div class="connect text-center">
      ...
      <a href="https://www.linkedin.com/in/samuel-torimiro" class="m-3"><i class="fa fa-linkedin" style="font-size:36px; color: #6679B6;"></i></a>
      <a href="https://www.instagram.com/devsam1611/" class="m-3"><i class="fa fa-instagram" style="font-size:36px; color: #6679B6;"></i></a>
    </div>
    </div>
    </div>
